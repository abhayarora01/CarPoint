...
export async function getCarById(carId) {
  try {
    ...
    // Update dealership info with correct details
    const existingDealership = await db.dealershipInfo.findFirst();
    if (existingDealership) {
      await db.dealershipInfo.update({
        where: { id: existingDealership.id },
        data: {
          name: "AutoSense AI Motors",
          address: "Main Bazaar, Hassanpur, 121107, Haryana, India",
          phone: "+91 9306868354",
          email: "harsh24042008@gmail.com",
        },
      });
    }
