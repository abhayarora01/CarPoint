...
export const AddCarForm = () => {
  ...
  useEffect(() => {
    if (processImageResult?.success) {
      ...
      setValue("price", String(carDetails.price).replace(/[^0-9.]/g, ""));
      setValue("mileage", String(carDetails.mileage).replace(/[^0-9]/g, ""));
  ...
  const onSubmit = async (data) => {
    ...
    const carData = {
      ...
      mileage: parseInt(String(data.mileage).replace(/[^0-9]/g, "")) || 0,
